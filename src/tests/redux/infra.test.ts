...
describe('ReduxFlagShaper', () => {
  describe('SelectorBuilder', () => {
    ...
    it('Should allow not flagged states', () => {
      ...
      assertType<typeof selectedItem>(is => is.equals(state.prop1));
      expect(selectedItem).toEqual(state.prop1);

      assertType<typeof selectedDeepItem>(is => is.equals(state.prop4.test4.testDeep4.reallyDeep3));
    ...
    it('Should allow mix states', () => {
      ...
      assertType<typeof selectedItem>(is => is.equals(state.prop4.test4.addedInA));
    ...
    it('should allow anidate selectors', () => {
      ...
      assertType<typeof selectedItem>(is => is.equals(state.prop4.test4.testDeep4.reallyDeep3));
      expect(selectedItem).toEqual(state.prop4.test4.testDeep4.reallyDeep3);
    });
  });
});